    ...
    <div style={BannerStyle} className="sm:min-h-[400px] sm:flex sm:justify-end sm:items-center rounded-xl">
      <div>
        <div className="space-y-6-max-w-xl mx-auto">
          ...
          className="text-center sm:px-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores deleniti dolor sit amet consectetur adipisicing elit voluptatum.{" "}</motion.p>
          {/* images link */}
          <div 
